# -*- coding: utf-8 -*-
"""
Created on Sat Mar 24 02:35:44 2018
...
#        
            ...
            #encoded=str(encoded)
            d_encoded = encoded.decode('utf-8')
...
def updateProduct(myuuid): 
    ...
    try:   
        jwt.decode(data2["d_encoded"], 'secret', leeway=10, algorithms=['HS256'],verify= True)
...
#        return jsonify({'Token Expired'})
    encoded = 'Bearer ' + data2["d_encoded"]
...
#        
            ...
            uniqueId = str(uniqueId)
            data['uuid'] = uniqueId
            only_token = data2["d_encoded"]
            only_token = str(only_token)
            data['d_encoded'] = only_token
...
@app.route('/orgdb/product/upload_file/getAll/<uuid>', methods=['PUT'])
